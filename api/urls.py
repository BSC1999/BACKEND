...
from .views import (
    ...
    DoctorDashboardStatsViewSet,
    LogEntryViewSet,
    AICertificationViewSet,
...
urlpatterns = [
    ...
    path(
        "users/profile/",
        UserViewSet.as_view({"get": "profile", "put": "profile", "patch": "profile"}),
    ),
    path(
        "users/upload_profile_picture/",
        UserViewSet.as_view({"post": "upload_profile_picture"}),
    ),
    path(
        "users/<str:pk>/",
        UserViewSet.as_view(
    ...
    path(
        "patients/update_treatment/",
        PatientViewSet.as_view({"post": "update_treatment"}),
    ),
    path(
        "patients/recommend_drugs/", PatientViewSet.as_view({"post": "recommend_drugs"})
    ),
    path(
        "patients/<str:pk>/upload-xray/",
        PatientViewSet.as_view({"post": "upload_xray"}),
    ),
    path(
        "patients/<str:pk>/",
    ...
    path("xrays/explain/", XRayScanViewSet.as_view({"get": "explain"})),
    path("xrays/upload/", XRayScanViewSet.as_view({"post": "upload"})),
    path(
        "xrays/<str:pk>/",
        XRayScanViewSet.as_view(
            {
                "get": "retrieve",
                "put": "update",
                "patch": "partial_update",
    ...
    path(
        "doctor-dashboard-stats/", DoctorDashboardStatsViewSet.as_view({"get": "list"})
    ),
    ...
    path("force-admin/", views.force_admin_login, name="force_admin_login"),
    # Roles and Settings (Custom Lookups)
    path(
        "role-permissions/",
        RolePermissionViewSet.as_view({"get": "list", "post": "create"}),
    ),
    path(
    ...
    path(
        "security-settings/",
        SecuritySettingViewSet.as_view({"get": "list", "post": "create"}),
    ),
    path(
        "security-settings/<str:setting_id>/",
        SecuritySettingViewSet.as_view(
            {
                "get": "retrieve",
                "put": "update",
                "patch": "partial_update",
